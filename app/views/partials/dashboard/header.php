    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= BASEURL ?>/dashboard">
                ...
                <div class="sidebar-brand-text mx-3">JalanKuy</div>
            </a>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?= BASEURL . '/dashboard/typetransport' ?>">
                    <i class="fas fa-fw fa-rocket"></i>
                    <span>Type Transportasi</span></a>
            </li>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?= BASEURL . '/dashboard/petugas' ?>">
                    <i class="fas fa-fw fa-users-cog"></i>
                    <span>Petugas</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= BASEURL . '/dashboard/rute' ?>">
                    <i class="fas fa-fw fa-map-marker-alt"></i>
                    <span>Rute</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= BASEURL . '/dashboard/penumpang' ?>">
